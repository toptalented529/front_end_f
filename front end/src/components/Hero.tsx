...
export function Hero(): JSX.Element {
  ...
  return (
    // <div className="flex flex-col justify-start items-center mx-auto mb-12 sm:flex-row sm:mb-24">
      <div className="flex flex-col items-center justify-center w-full px-6 pt-0 pb-24 lg:w-full text-gray-50 h-screen">
        ...
        >
          <a href="mailto:work.katashi@gmail.com">Contact us</a>
        </button>
      </div>
    // </div>
  );
